...
// turn on the generate button glow effect when a URL is in the input box
imageLink.addEventListener('input', function() {
    submitButton.classList.add('button-glow');
});

// create the meme upon submit event
// reset input values upon submit
...
function addMeme(link, topText, bottomText) {
    ...
    // this prevents the user from deleting the entire containing div if they click outside of a meme
